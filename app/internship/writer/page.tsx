...
export default function RegistrationPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.post(`${apiRoute}/writer-sheet`, {
                Name: fullName,
                Email: email,
                Phone: phone,
                School: school,
                                            ...
                                            <div key={index} className="flex flex-row gap-2 items-center h-full">
                                                <div>
                                                    <div
                                                        ...
                                                        className={`aspect-square w-4 border border-primary rounded-sm relative cursor-pointer ${writing.includes(writingOption) ? "bg-primary" : ""
                                                            }`}
                                                    >
