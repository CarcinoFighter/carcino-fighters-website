...
async function run() {
  ...
  results.push(await testEndpoint('/api/articles'));

  fs.writeFileSync(path.join(__dirname, 'test-results-alt.json'), JSON.stringify(results, null, 2));
  console.log('Results written to tmp/test-results-alt.json');
}
